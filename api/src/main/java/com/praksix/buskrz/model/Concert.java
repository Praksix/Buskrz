...
public class Concert {
    ...
    public Concert(String id, String name, List<String> artisteIds, String lieuId, LocalDate date, LocalTime time,
            String prix, String description, String image, String lien, String status) {
        this.id = id;
        this.name = name;
